...
# Save the best model and vectorizer (outside the Streamlit app)
...
# Train and select the best model (inside a loop)
# ... (same as previous solution)

# Streamlit App
def run_chatbot(best_model, vectorizer):
...
# Call the Streamlit app function with best_model
run_chatbot(best_model, vectorizer)
# --- Data Preparation ---
data = {
    'text': [
